...
# 涨停池 / 跌停池：自 v3.3.0 起改由 a-stock-data Layer 8（em_zt_pool/em_dt_pool）提供，
# 回归覆盖在 scripts/a_stock_data/smoke_test.py 的 test_em_zt_pool，此处不再重复测。
...
TESTS = [test_market_breadth, test_concept_blocks_and_members]
